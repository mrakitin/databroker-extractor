...
if __name__ == '__main__':
    ...
    if fiber_scan:
        ...
        ax.grid()
        ax.plot(mean_dark_field[:, first_slice], label='pixel={}'.format(first_slice), cmap=cmap)
        ax.plot(mean_dark_field[:, second_slice], label='pixel={}'.format(second_slice), cmap=cmap)
        ax.plot(mean_dark_field[:, third_slice], label='pixel={}'.format(third_slice), cmap=cmap)
        ax.legend()
        ...
        ax.set_xlim((0, shape[0]))
        ax.grid()
        ax.plot(mean_diff_fiber_in[:, first_slice], label='pixel={}'.format(first_slice), cmap=cmap)
        ax.plot(mean_diff_fiber_in[:, second_slice], label='pixel={}'.format(second_slice), cmap=cmap)
        ax.plot(mean_diff_fiber_in[:, third_slice], label='pixel={}'.format(third_slice), cmap=cmap)
        ax.legend()
        ...
        ax.set_xlim((0, shape[0]))
        ax.grid()
        ax.plot(mean_diff_fiber_out[:, first_slice], label='pixel={}'.format(first_slice), cmap=cmap)
        ax.plot(mean_diff_fiber_out[:, second_slice], label='pixel={}'.format(second_slice), cmap=cmap)
        ax.plot(mean_diff_fiber_out[:, third_slice], label='pixel={}'.format(third_slice), cmap=cmap)
        ax.legend()
